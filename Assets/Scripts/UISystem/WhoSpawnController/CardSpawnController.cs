...
namespace UISystem.WhoSpawnController
{
    public class CardSpawnController : MonoBehaviour
    {
        ...
        [SerializeField]private SerializedDictionary<CardType, SpawnCardData> selectedCards = new SerializedDictionary<CardType, SpawnCardData>(); // seçilen kartlar
        ...
        private void Awake()
        {
            ...
            {
                selectedCards.Add(card, new SpawnCardData());
            }
        ...
        public void ShowCardSelection(CardType cardType, int lwl)
        {
            ...
            foreach (var VARIABLE in selectedCards.Keys)
            {
                if (selectedCards[VARIABLE].Active)
                {
                    ...
                    PlayerSignals.Instance.onSpawnEnum?.Invoke(VARIABLE,selectedCards[VARIABLE].Lwl);
                }
            }
